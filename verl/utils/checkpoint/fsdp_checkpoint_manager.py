...
class FSDPCheckpointManager(BaseCheckpointManager):
    ...
    def load_checkpoint(self, path=None, del_local_after_load=False, *args, **kwargs):
        ...
        model_state_dict = torch.load(local_model_path, weight_only=False)
        optimizer_state_dict = torch.load(local_optim_path, weight_only=False)
        extra_state_dict = torch.load(local_extra_state_path, weight_only=False)
